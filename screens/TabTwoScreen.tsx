...
function CAL(CalProps: any) {
  return (
    <Calendar
      ...
      onDayPress={(day) => {
        CalProps.setDay(day.dateString);
      }}
      minDate="2023-01-01"
      maxDate="2025-01-31"
      hideExtraDays={true}
...
function helper() {
  ...
  console.log(date);
  var addzeroDate = "";
  if (date < 10) addzeroDate = "0";
  var addZeroMonth = "";
  if (month < 10) addZeroMonth = "0";
...
function getLogsv2(date: string, db: any) {
  ...
  console.log(ret);
  if (ret == "") return "No data for the selected date";
  return ret;
}
...
const DATA: Year = {
  "2023": {
    ...
    "03": {
      "01": { Cannabis: 1 },
      "02": { Cannabis: 2 },
      "03": { Alcohol: 4, Cannabis: 1 },
      "04": { Alcohol: 4, Xanax: 1 },
      "05": { MDMA: 2 },
      "06": { Alcohol: 12 },
    },
    "04": {},
