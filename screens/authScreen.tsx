    ...
    if (signingIn) {
        ...
        return (
            <SafeAreaProvider>
                ...
                <Button title="Sign In" style={styles.buttonRight} onPress={() => { alias(authSignIn(uninput, pwinput, setErrorMsg)) }}></Button>
                <Text style={styles.errmsg}>{errorMsg}</Text>
                <Text style={styles.separator} />
                <Text style={styles.switch}>Don't have an account?</Text>
                <Button title="Sign Up" style={styles.buttonMid} onPress={() => { setSI(false), setErrorMsg('') }} ></Button>
            </SafeAreaProvider >
        )
    }
    else {
        ...
        return (
            <SafeAreaProvider>
                ...
                <Button style={styles.buttonMid} title="Sign In" onPress={() => { setSI(true), setErrorMsg('') }} ></Button>
            </SafeAreaProvider>
        )
    }
}
...
function authSignIn(un: string, pw: string, err: React.Dispatch<React.SetStateAction<string>>) {
    if (un == '' || pw == '') {
        err('')
        return false;
    }
